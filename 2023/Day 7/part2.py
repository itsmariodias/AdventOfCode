...
def determine_strength(x):
    joker_count = Counter(x).get('J', 0)
    x_counter = Counter(x.replace('J', '')).most_common()
    if (joker_count == 5
            or x_counter[0][1] == 5
            or (x_counter[0][1] == 4 and joker_count == 1)
            or (x_counter[0][1] == 3 and joker_count == 2)
            or (x_counter[0][1] == 2 and joker_count == 3)
            or (x_counter[0][1] == 1 and joker_count == 4)):
        return 1
    elif (x_counter[0][1] == 4
          or (x_counter[0][1] == 3 and joker_count == 1)
          or (x_counter[0][1] == 2 and joker_count == 2)
          or (x_counter[0][1] == 1 and joker_count == 3)):
        return 2
    elif ((x_counter[0][1] == 3 and x_counter[1][1] == 2)
          or (x_counter[0][1] == 2 and x_counter[1][1] == 2 and joker_count == 1)):
        return 3
    elif (x_counter[0][1] == 3
          or (x_counter[0][1] == 2 and joker_count == 1)
          or (x_counter[0][1] == 1 and joker_count == 2)):
        return 4
    elif x_counter[0][1] == 2 and x_counter[1][1] == 2:
        return 5
    elif (x_counter[0][1] == 2
          or (x_counter[0][1] == 1 and joker_count == 1)):
        return 6
    else:
        return 7
